...
APP_VERSION = "v2.2 (Week 12 - Testing & QA)"
...
APP_VERSION = "v2.1 (Week 11 - UI Polish)"
...
class NewtonRaphsonApp:
    ...
    def create_widgets(self):
        ...
        footer.columnconfigure((0,1,2), weight=0)
        ...
        warning_info.grid(row=0, column=2, padx=15, pady=12)
        ...
        about_btn.grid(row=0, column=4, padx=(0, 15), pady=12)
    ...
    def show_about(self):
        ...
        messagebox.showinfo(
            "About",
        "🧮 Newton-Raphson Root Finder v2.2\n\n"
        "Week 12 - Testing & QA Output\n\n"
        "Goal:\n"
        "Provide strong evidence of correctness through testing and bug-fixing.\n\n"
        "Required Outputs (covered in project report):\n"
        "• Testing checklist (10+ tests)\n"
        "• Bug list with fixes summary (>=3 fixes)\n"
        "• Regression tests to re-run earlier tests\n\n"
        "Notes:\n"
        "• See week12_testing_report.md for the full checklist, bug summaries, and reflections.\n"
        "• Use the Export buttons to save TXT/HTML reports for evidence attachment.\n\n"
        "Key Features & Guarantees:\n"
        "• Step-by-step solution trail with exportable reports\n"
        "• Input validation and robust edge-case detection\n"
        "• Safety checks for NaN/Inf, zero derivatives, and small denominators\n\n"
        "Developed by:\n"
        "• Charles Russel San Juan\n"
        "• Christina Gomba\n"
        "• John Michael Tulalian\n\n"
        "Version: v2.2 (Week 12 - Testing & QA)"
        )
...
"""
        ...
        html_content += f"""
    <div class="footer">
        <p>Report generated by Newton-Raphson Root Finder v2.0</p>
