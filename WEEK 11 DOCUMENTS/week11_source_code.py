...
class NewtonRaphsonApp:
    ...
    def show_about(self):
        ...
        messagebox.showinfo(
            "About",
        "🧮 Newton-Raphson Root Finder v2.1\n\n"
        "Week 11 - UI/Formatting Improvements\n\n"
        "Description:\n"
        "A numerical computation tool designed to find roots of nonlinear equations "
        "using iterative methods with enhanced UI and trail formatting.\n\n"
        "UI Improvements (Week 11):\n"
        "• Grid-based layout for perfect label/input alignment\n"
        "• Consistent spacing and padding throughout\n"
        "• Standardized trail formatting with clear section headers\n"
        "• Enhanced visual hierarchy and readability\n"
        "• Improved button layout and footer organization\n"
        "• Interactive tooltips for all input fields\n"
        "• Real-time progress bar during computation\n"
        "• Status indicators and computation time display\n"
        "• Keyboard shortcuts (Ctrl+Enter, Ctrl+L, Ctrl+E)\n"
        "• Enhanced button styling with borders and multi-line text\n\n"
        "Methods Implemented:\n"
